...
/* 
    * isAccessVerity = false, isLogout = false : Access Token이 만료된 경우 
    * isAccessVerity = false, isLogout = true : Access Token이 올바르지 않은 경우, Access Token 유효성 확인 중 에러
    * isAccessVerity = true, isLogout = false : Access Token이 유효하며 로그인을 유지하는 경우
    * isAccessVerity = null, isLogout = false : Access Token이 없는 경우
*/
